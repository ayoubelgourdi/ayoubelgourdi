<p align="center">
  ...
  <g id="terminal-part">
    ...
    <text x="20" y="40" font-family="monospace" font-size="14" fill="#50fa7b">ayoubelgourdi@github:~$ <tspan font-family="monospace" font-size="14" fill="#f8f8f2">GET profile ayoubelgourdi --verbose</tspan></text>
    
    <!-- Loading message - repositioned higher -->
    <text x="20" y="70" font-family="monospace" font-size="16" fill="#bd93f9" font-weight="bold">Loading ayoubelgourdi's profile...</text>
  ...
  <g id="welcome-part" opacity="0">
    ...
    <text x="400" y="100" font-family="Impact, Haettenschweiler, Arial Narrow Bold, sans-serif" font-size="38" text-anchor="middle" fill="#ff5555" opacity="0.5">
      Welcome to ayoubelgourdi's Github Profile
  ...
  <g id="profile-part" opacity="0">
    ...
    <text x="400" y="130" font-family="Helvetica, Arial, sans-serif" font-size="18" text-anchor="middle" fill="#8be9fd" opacity="0">
      Web Developer | Learning & Building | Agadir
